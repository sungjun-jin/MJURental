...
public interface AuthCodeManager {
     ...
     * @param authCodeCallback Success/Failure callback for getting authorization code
     */
    void requestAuthCode(final AuthType authType, final StartActivityWrapper wrapper, final Map<String, String> extraParams, AuthCodeCallback authCodeCallback);
     ...
     * @param data        {@link Intent} delivered from {@link Activity#onActivityResult(int, int, Intent)}
